<template>
  <div>
    ...
    <div class="relative mx-auto flex flex-col px-6 space-y-4 max-w-4xl">
      <div class="bg-slate-300 px-4 py-6">
        ...
        <div class="py-6 w-full">
          <NuxtLinkLocale to="https://sabilajati.com/faq" class="border-2 border-black px-4 py-3 hover:bg-black hover:text-white">{{ $t('See FAQ') }}</NuxtLinkLocale>
        </div>
      </div>
